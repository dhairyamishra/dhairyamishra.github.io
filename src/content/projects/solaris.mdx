...
<Figure
  ...
  width="wide"
  caption="Player one: Solaris generates a synchronized first-person observation in Minecraft."
/>
...
<Figure
  ...
  width="wide"
  caption="Player two: the paired first-person observation remains synchronized with the same multiplayer world state."
/>
